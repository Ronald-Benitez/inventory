...
import EnterprisesTable from "@/components/enterprises/enterprises-table"
import EnterprisesModal from "@/components/enterprises/enterprises-modal"
...
export default function Inventory() {
    ...
    const loadDataTable = () => {
        toast.remove()
        toast.loading("Cargando empresas...")
        axios.get(`/api/enterprises/${skip}/${take}`).then((res) => {
    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center">
                ...
                <h1 className="text-4xl font-bold text-center my-2">Empresas</h1>
                <div className="flex justify-center my-2">
                    <EnterprisesModal reload={() => { setReload(!reload) }} data={null} />
                </div>

                <div className="mt-5 rounded w-full lg:w-4/5 mb-4 px-2">
                    <EnterprisesTable reload={() => { setReload(!reload) }} data={data} />
                </div>
