...
import DiscountsModal from "@/components/discounts/discounts-modal"
...
export default function Inventory() {
    const [data, setData] = useState<DiscountsWitProduct[] | []>([])
    ...
    const loadDataTable = () => {
        toast.remove()
        toast.loading("Cargando descuentos...")
        axios.get(`/api/discounts/${skip}/${take}`).then((res) => {
            setData(res.data as DiscountsWitProduct[])
            toast.remove()
    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center">
                ...
                <h1 className="text-4xl font-bold text-center my-2">Descuentos</h1>
                <div className="flex justify-center my-2">
                    <DiscountsModal reload={() => { setReload(!reload) }} />
                </div>

                <div className="mt-5 rounded w-full lg:w-4/5 mb-4 px-2">
                    <DiscountsTable reload={() => { setReload(!reload) }} data={data} />
                </div>
