...
import Modal from "@/components/categories/categories-modal"
import Table from "@/components/categories/categories-table"
...
export default function Inventory() {
    ...
    const loadDataTable = () => {
        ...
        axios.get(`/api/dynamic/categories/${skip}/${take}`).then((res) => {
            setData(res.data as Categories[])
            toast.remove()
    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center">
                ...
                <h1 className="text-4xl font-bold text-center my-3">Categorias</h1>
                <div className="flex justify-center my-2">
                    <Modal reload={() => { setReload(!reload) }} data={null} />
                </div>

                <div className="mt-5 rounded w-full lg:w-4/5 mb-4 px-2">
                    <Table data={data} reload={() => setReload(!reload)} />
                </div>
